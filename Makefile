...
# -------------------------------
VPATH=/opt/9fdev/binutils217

build_alias=x86_64-unknown-linux-gnu
build=x86_64-unknown-linux-gnu
host_alias=x86_64-unknown-linux-gnu
host=x86_64-unknown-linux-gnu
target_alias=i386-unknown-plan9
target=i386-unknown-plan9

program_transform_name = s,^,i386-unknown-plan9-,; 

prefix = /opt/9fdev/binut217
exec_prefix = ${prefix}

srcdir = /opt/9fdev/binutils217
...
TOPLEVEL_CONFIGURE_ARGUMENTS=/opt/9fdev/binutils217/configure --disable-werror --prefix=/opt/9fdev/binut217 --target=i386-unknown-plan9

tooldir = ${exec_prefix}/i386-unknown-plan9
build_tooldir = ${exec_prefix}/i386-unknown-plan9
...
BUILD_CONFIGARGS = --cache-file=../config.cache --build=x86_64-unknown-linux-gnu --host=x86_64-unknown-linux-gnu --target=i386-unknown-plan9 --disable-werror --prefix=/opt/9fdev/binut217 --program-transform-name='s,^,i386-unknown-plan9-,; ' --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS = --cache-file=./config.cache --build=x86_64-unknown-linux-gnu --host=x86_64-unknown-linux-gnu --target=i386-unknown-plan9  --with-gnu-as --with-gnu-ld --disable-werror --prefix=/opt/9fdev/binut217 --program-transform-name='s,^,i386-unknown-plan9-,; '
...
TARGET_SUBDIR = i386-unknown-plan9
# This is set by the configure script to the arguments to use when configuring
# directories built for the target.
TARGET_CONFIGARGS = --cache-file=./config.cache --build=x86_64-unknown-linux-gnu --host=i386-unknown-plan9 --target=i386-unknown-plan9 --enable-multilib --with-cross-host=x86_64-unknown-linux-gnu --disable-werror --prefix=/opt/9fdev/binut217 --program-transform-name='s,^,i386-unknown-plan9-,; ' --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
CC_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-unknown-plan9-cc $(FLAGS_FOR_TARGET)

# If GCC_FOR_TARGET is not overriden on the command line, then this
# variable is passed down to the gcc Makefile, where it is used to
# build libgcc2.a.  We define it here so that it can itself be
# overridden on the command line.
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-unknown-plan9-gcc $(FLAGS_FOR_TARGET)
CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-unknown-plan9-c++ $(FLAGS_FOR_TARGET)
RAW_CXX_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-unknown-plan9-c++ $(FLAGS_FOR_TARGET)
GCJ_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-unknown-plan9-gcj $(FLAGS_FOR_TARGET)
GFORTRAN_FOR_TARGET=$(STAGE_CC_WRAPPER) i386-unknown-plan9-gfortran $(FLAGS_FOR_TARGET)
DLLTOOL_FOR_TARGET=$$r/$(HOST_SUBDIR)/binutils/dlltool
LD_FOR_TARGET=$$r/$(HOST_SUBDIR)/ld/ld-new

LIPO_FOR_TARGET=i386-unknown-plan9-lipo
