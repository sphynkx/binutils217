...
TOPLEVEL_CONFIGURE_ARGUMENTS=./configure --prefix=/tmp/binut217 --disable-werror
...
BUILD_CONFIGARGS = --cache-file=../config.cache --build=x86_64-unknown-linux-gnu --host=x86_64-unknown-linux-gnu --target=x86_64-unknown-linux-gnu --prefix=/tmp/binut217 --disable-werror --program-transform-name='s,y,y,' --with-build-subdir="$(BUILD_SUBDIR)"
...
HOST_CONFIGARGS = --cache-file=./config.cache --build=x86_64-unknown-linux-gnu --host=x86_64-unknown-linux-gnu --target=x86_64-unknown-linux-gnu  --with-gnu-as --with-gnu-ld --prefix=/tmp/binut217 --disable-werror --program-transform-name='s,y,y,'
...
TARGET_CONFIGARGS = --cache-file=./config.cache --build=x86_64-unknown-linux-gnu --host=x86_64-unknown-linux-gnu --target=x86_64-unknown-linux-gnu --enable-multilib --prefix=/tmp/binut217 --disable-werror --program-transform-name='s,y,y,' --with-target-subdir="$(TARGET_SUBDIR)"
# This is the list of variables to export in the environment when
...
GCC_FOR_TARGET=$(STAGE_CC_WRAPPER) $() $(FLAGS_FOR_TARGET)
